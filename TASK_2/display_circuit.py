...
show_circuit("Grover Circuit", circuit.grover_circuit(5, '11111'))
show_circuit("Parameterized Circuit", circuit.parameterized_circuit(2, [('rx', np.pi/2), ('ry', np.pi)]))
show_circuit("Variable Depth Circuit", circuit.variable_depth_circuit(3, 2))